...
@AnalyzeClasses(packagesOf = ConferencemsApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .layer("Persistence").definedBy("..repository..").withOptionalLayers(true) 
        ...
        .ignoreDependency(belongToAnyOf(ConferencemsApp.class), alwaysTrue())
