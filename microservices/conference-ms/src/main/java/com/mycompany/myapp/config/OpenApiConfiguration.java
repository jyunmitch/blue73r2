...
@OpenAPIDefinition(
    info = @Info(title = "Conferencems", description = "Provide a description for your application.", version = "v1"),
...
public class OpenApiConfiguration {
    ...
    public static final String API_FIRST_PACKAGE = "com.mycompany.myapp.web";
